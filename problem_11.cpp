...
int main() {
  ...
  long up = 0;
  long across = 0;
  long diagonal_right = 0;
  long diagonal_left = 0;
  ...
  long max1 = max(up, across);
  long max2 = max(max1, diagonal_left);
  long finalmax = max(max2, diagonal_right);
